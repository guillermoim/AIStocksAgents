...
stock = 'NK225'
df = Data.get_pandas_dataframe(r'datasets/nikkei225.csv', 'Open').drop(columns=['index'])
title = 'NK225'
...
alg = Alg.Algorithm(prices, volumes, memory, Mt, Dt, n, s, ga, gm, pmax, itera, ncycles, init_nn_train_idx, end_nn_train_idx, cut_idx, final_idx, max_t)
