...
class Agent:
    ...
    def evaluate_strategies(self, prices, Mt, Dt, Yt, t):  # Evaluate the strategies for Mt, Dt, Yt at time step t
        """
        ...
        for s in self.strategies:
            ...
            i_y = ut.impact_factor(Yt, s.ty, t)

            current_position = s.pos
            current_cash = s.cash

            # Compute the strategy position-change level
            l_t = s.alpha * s.em * i_m + s.beta * s.ed * i_d + s.gamma * s.ey * i_y
    ...
    def evolve_strategies(self, gm, gp, pool, price):
        """
